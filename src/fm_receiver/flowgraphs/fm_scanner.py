...
import fm_scanner_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class fm_scanner(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_scanner")
        ...
        self.freq = freq = 87.7*10**6
        self.fft_size = fft_size = 2**10

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(87.7*10**6, 107.9*10**6, 200*10**3, 87.7*10**6, 200)
        ...
        self.single_pole_iir_filter_xx_0 = filter.single_pole_iir_filter_ff(0.1, fft_size)
        ...
        self.epy_block_0 = epy_block_0.blk(threshold_value=-12, vector_length=fft_size)
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_vector_sink_f_0_0, 0))
        ...
        self.connect((self.soapy_rtlsdr_source_0, 0), (self.qtgui_freq_sink_x_1, 0))
    ...
    def set_fft_size(self, fft_size):
        ...
        self.epy_block_0.vector_length = self.fft_size
